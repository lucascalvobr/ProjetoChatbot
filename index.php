...
<body>
    ...
    <div class="footer">
        <div class="mapa"></div>
        <div class="endereco">Rua Akida Ban 666 Capinho Quadrado - Taboão das Trevas - SP</div>
        <div class="direitos">Nenhum Direito Reservado - Projeto Realizado para Fims Educacionais. Dispolibilizado para qualquer um no GitHub.</div>
    </div>
